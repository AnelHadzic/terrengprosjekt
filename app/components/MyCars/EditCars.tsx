...
const EditCars = () => {
  ...
  const setPrimaryCarAtIndex = (index: number) => {
    if (regNumbers[index] !== primaryCar) {
      setPrimaryCar(regNumbers[index])
    } else {
      setPrimaryCar("")
    }
  }
        ...
        {regNumbers.map((regnr, index) => (
          <React.Fragment key={index}>
            <div className="flex flex-row ...">
              ...
              <button
                type="button"
                onClick={() => setPrimaryCarAtIndex(index)}
                className={
                  regnr !== "" && regnr === primaryCar
