      ...
      <>
        ...
        <div className="flex flex-col items-center">
          {userParkingHistory.map((parking) => (
            <div
              key={parking._id}
              className="max-w-sm min-w-[300px] mb-3 p-6 bg-gray-100 border border-gray-200 rounded-lg shadow"
            >
    ...
    <>
      <div className="flex">
        ...
        <button
          type="button"
          onClick={() => setPage((prev) => prev + 1)}
          className="text-white flex flex-row bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2"
        >
          Neste
          <svg
